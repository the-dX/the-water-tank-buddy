<!DOCTYPE html> 
<head> 
<title>Tankers Information</title> 
			...
			<div class="aaa">
				<div class="panel panel-default" align="center">
                            <div class="panel-heading" align="center">
                                <h4><a href=enq.php>Tankers Information</a></h4>
                            </div>
                ...
                <div class="row">
					...
					<form name="Registration" action="" method="post">
							<div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Tankers Assigned:" name="uin"  required/><br>
								<input type="text" class="form-control" placeholder="Uin:" name="uin1"  required/>
                            </div>
                            </form>
					</div>
                </div>
