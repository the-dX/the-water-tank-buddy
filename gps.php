			...
			<div class="aaa">
				<div class="panel panel-default" align="center">
                            <div class="panel-heading" align="center">
                                <h4><a href=enq.php>Track The Tank</a></h4>
                            </div>
                ...
                <div class="row">
					...
					<form name="Registration" action="" method="post">
							<div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Unique Identification Number" name="a1"  required/>
                            </div>
                            </form>
					</div>
                </div>
							...
							<button ><a href="gps.html">Submit</button></a>
