                ...
                <div class="row">
					...
					<form name="Registration" action="" method="post">
							<div class="form-group">
                                ...
                                <!!<input type="text" class="form-control" placeholder="Enter Unique Identification Number" name="uin"  required/>
								<textarea  type=text name="t1" rows="3" cols="50"></textarea><br><br>
                            </div>
                            </form>
					</div>
                </div>
